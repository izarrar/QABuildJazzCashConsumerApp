...
public class pompak {public pompak(AppiumDriver<AndroidElement> driver) {
	...
	///////////////////////pompak////////////////////////////////////////////////////////////////
	 ...
	 @AndroidFindBy(id=("com.techlogix.mobilinkcustomer:id/search_bottom_nav"))
		public AndroidElement SearchApp_pompak;
	 
	 
	 
	 @AndroidFindBy(id=(" com.techlogix.mobilinkcustomer:id/tv_title"))
		public AndroidElement Pompak_Search;
	
	 
	 @AndroidFindBy(id=("com.techlogix.mobilinkcustomer:id/play_pause_button"))
		public AndroidElement play_Video;
	 

	 @AndroidFindBy(id=("com.techlogix.mobilinkcustomer:id/btn_watch_vide"))
		public AndroidElement Download_Button;
